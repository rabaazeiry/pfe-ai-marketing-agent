// backend/scripts/scrape-industry-beauty.js
// Smart batch: scrapes the 8 beauty brands, auto-skips any brand that
// already has ≥ SKIP_THRESHOLD posts in MongoDB. Re-runnable + resumable.
//
// Usage:
//   node scripts/scrape-industry-beauty.js
...
const PROJECT_NAME    = 'PFE Analysis - Beauty';
...
const RESULTS_FILE    = path.resolve(__dirname, '..', 'beauty-batch-results.json');
...
(async () => {
  ...
  try {
    ...
    console.log('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log('📊 BEAUTY BATCH RECAP');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
