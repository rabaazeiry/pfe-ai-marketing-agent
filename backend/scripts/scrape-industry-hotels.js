// backend/scripts/scrape-industry-hotels.js
// Smart batch: scrapes the 10 hotel brands, auto-skips any brand that
// already has ≥ SKIP_THRESHOLD posts in MongoDB. Re-runnable + resumable.
//
// Usage:
//   node scripts/scrape-industry-hotels.js
...
// CONFIG
// ═══════════════════════════════════════════════════════════
const INDUSTRY        = 'hotels';
const PROJECT_NAME    = 'PFE Analysis - Hotels';
...
const RESULTS_FILE    = path.resolve(__dirname, '..', 'hotels-batch-results.json');

const BRANDS = [
  // ═══ INTERNATIONAL CHAINS IN TUNISIA (5) — sorted by followers ═══
  'fstunis',                // 121K, 20 posts ⚠️ (Four Seasons)
  'soussepearlmarriott',    // 61K, 1008 posts (Marriott)
  'hiltonskanesmonastir',   // 49K, 167 posts (Hilton)
  'radissonblutunis',       // 38K, 525 posts (Radisson)
  'tunismarriott',          // 38K, 451 posts (Marriott)
  // ═══ LOCAL TUNISIAN HOTELS (5) — sorted by followers ═══
  'la_badira',              // 85K, 873 posts
  'movenpick_hotel_gammarth', // 47K, 1623 posts
  'el_mouradi_hotels',      // 38K, 1208 posts
  'movenpicklactunis',      // 36K, 1176 posts
  'theresidencetunis',      // 26K, 1592 posts
];
...
(async () => {
  ...
  try {
    ...
    console.log('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log('📊 HOTELS BATCH RECAP');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
