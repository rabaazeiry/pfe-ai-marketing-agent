/**
 * Prophet Instagram Scraper — HOTELS
 * Scrapes posts from 2023-01-01 to today for 9 hotel brands.
 * Stores in `prophet_posts` collection (same as other industries).
 * Does NOT touch competitorprofiles.
 *
 * Usage:  node backend/scripts/prophet_scrape_hotels.js
...
// Per-brand isLocal mapping
const BRANDS = [
  { username: 'la_badira',               isLocal: true  },
  { username: 'soussepearlmarriott',     isLocal: false },
  { username: 'hiltonskanesmonastir',    isLocal: false },
  { username: 'movenpick_hotel_gammarth',isLocal: true  },
  { username: 'el_mouradi_hotels',       isLocal: true  },
  { username: 'radissonblutunis',        isLocal: false },
  { username: 'tunismarriott',           isLocal: false },
  { username: 'movenpicklactunis',       isLocal: true  },
  { username: 'theresidencetunis',       isLocal: true  },
];
...
function printReport(results) {
  ...
  console.log('  PROPHET SCRAPE — HOTELS — FINAL REPORT');
  console.log('═'.repeat(72));
  ...
  console.log('\n' + '─'.repeat(72));
  console.log(`  Total posts hotels (this run) : ${totalPosts}`);
