// backend/scripts/scrape-industry-patisserie.js
// Smart batch: scrapes the 8 pâtisserie brands, auto-skips any brand that
// already has ≥ SKIP_THRESHOLD posts in MongoDB. Re-runnable + resumable.
//
// Usage:
//   node scripts/scrape-industry-patisserie.js
...
// ═══════════════════════════════════════════════════════════
const INDUSTRY        = 'food';
const PROJECT_NAME    = 'PFE Analysis - Food';
...
const RESULTS_FILE    = path.resolve(__dirname, '..', 'patisserie-batch-results.json');
...
(async () => {
  ...
  try {
    ...
    console.log('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log('📊 PATISSERIE BATCH RECAP');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
