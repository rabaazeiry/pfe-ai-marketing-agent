/**
 * Prophet Instagram Scraper — FASHION (local brands only)
 * Scrapes posts from 2023-01-01 to today for 4 local fashion brands.
 * Stores in `prophet_posts` collection (same as patisserie).
 * Does NOT touch competitorprofiles.
 *
 * Usage:  node backend/scripts/prophet_scrape_fashion.js
...
function printReport(results) {
  ...
  console.log('  PROPHET SCRAPE — FASHION (LOCAL) — FINAL REPORT');
  console.log('═'.repeat(72));
  ...
  console.log('\n' + '─'.repeat(72));
  console.log(`  Total posts fashion (this run) : ${totalPosts}`);
