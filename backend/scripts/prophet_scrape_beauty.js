/**
 * Prophet Instagram Scraper — BEAUTY (local brands only)
 * Scrapes posts from 2023-01-01 to today for 4 local beauty brands.
 * Stores in `prophet_posts` collection (same as patisserie + fashion).
 * Does NOT touch competitorprofiles.
 *
 * Usage:  node backend/scripts/prophet_scrape_beauty.js
...
function printReport(results) {
  ...
  console.log('  PROPHET SCRAPE — BEAUTY (LOCAL) — FINAL REPORT');
  console.log('═'.repeat(72));
  ...
  console.log('\n' + '─'.repeat(72));
  console.log(`  Total posts beauty (this run) : ${totalPosts}`);
...
async function main() {
  ...
  console.log(`Industry : ${INDUSTRY} (local only)`);
