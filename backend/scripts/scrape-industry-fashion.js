// backend/scripts/scrape-industry-fashion.js
// Smart batch: scrapes the 8 fashion brands, auto-skips any brand that
// already has ≥ SKIP_THRESHOLD posts in MongoDB. Re-runnable + resumable.
//
// Usage:
//   node scripts/scrape-industry-fashion.js
...
const PROJECT_NAME    = 'PFE Analysis - Fashion';
...
const RESULTS_FILE    = path.resolve(__dirname, '..', 'fashion-batch-results.json');

const BRANDS = [
  // ═══ INTERNATIONAL (4) — sorted by followers ═══
  'zara',              // 62M followers, 5230 posts
  'mango',             // ~17M followers
  'bershka',           // ~10M followers
  'pullandbear',       // ~9M followers
  // ═══ TUNISIA (4) — sorted by followers ═══
  'ha.hamadiabid',     // 400K, 1633 posts
  'zen.tunisie',       // 351K, 2091 posts
  'kastelo.com.tn',    // 205K, 1813 posts
  'chedly_sisters',    // 159K, 685 posts
];
...
(async () => {
  ...
  try {
    ...
    console.log('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log('📊 FASHION BATCH RECAP');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
