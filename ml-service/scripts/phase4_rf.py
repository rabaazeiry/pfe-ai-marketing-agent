...
else:  # v4 — V3 features + 15 CLIP-PCA visual features (step 4h)
    IN_PATH      = ROOT / "data"   / "df_ml_dataset_v4.parquet"
    MODEL_PATH   = ROOT / "models" / "rf_v4.pkl"
    COLUMNS_PATH = ROOT / "models" / "rf_v4_feature_columns.json"
    RESULTS_PATH = ROOT / "data"   / "rf_v4_results.txt"
    PRED_PATH    = ROOT / "data"   / "rf_v4_predictions.parquet"
    SHAP_HTML    = ROOT / "visualizations" / "v4" / "rf_v4_shap.html"
