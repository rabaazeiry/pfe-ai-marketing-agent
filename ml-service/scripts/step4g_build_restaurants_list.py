"""
Step 4g Phase 4 — Build Restaurants post list for multimodal scraping.
"""
import json
...
OUT = ROOT / "data" / "step4" / "restaurants_posts_list.json"

df = pd.read_parquet(PARQUET)
sub = df[df["industry_simple"] == "restaurants"].copy()
...
print(f"Wrote {len(records)} restaurants posts -> {OUT}")
print()
